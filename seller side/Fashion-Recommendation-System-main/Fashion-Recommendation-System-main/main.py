...
if uploaded_file is not None:
    ...
    if save_uploaded_file(uploaded_file):
        ...
        st.image(display_image, caption='Uploaded Image', width=150)
        ...
        with col1:
            st.image(filenames[indices[0][1]], caption='Recommendation 1', width=150)
        with col2:
            st.image(filenames[indices[0][2]], caption='Recommendation 2', width=150)
        with col3:
            st.image(filenames[indices[0][3]], caption='Recommendation 3', width=150)
        with col4:
            st.image(filenames[indices[0][4]], caption='Recommendation 4', width=150)
        with col5:
            st.image(filenames[indices[0][5]], caption='Recommendation 5', width=150)
